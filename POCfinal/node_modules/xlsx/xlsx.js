...
function parse_wb_xml(data, opts) {
	var wb = { AppVersion:{}, WBProps:{}, WBView:[], Sheets:[], CalcPr:{}, xmlns: "", data:"" };
	var pass = false, xmlns = "xmlns";
		/*Extentia*/
	wb.data = data;
//    var xml_re = /<definedName\s(\w+?)="(.+?)">[\s\S]*?<\/definedName>/;
//    
//    data.match(xml_re).forEach(function(d){
//        console.log( '   alpha ####   ', d);
//        wb.definedNames.push(d);
//    });
